...
<div class="filterbox">
    ...
    <div class="filtercontent">
        <input type="hidden" name="filtro[valor0]" id="valor0" value="<?php echo $filtros['filtros']['valor0']; ?>" />
        <input type="hidden" name="filtro[valor1]" id="valor1" value="<?php echo $filtros['filtros']['valor1']; ?>" />
...
<div class="filterbox">
    ...
    <div class="filteritem">
        <input type="checkbox" 
               <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('0', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?> 
               name="filtro[star][]" value="0" id="filtro_star0" 
            <?php 
                    if(empty($filtros['filtros']['estrelas'][0])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
        ...
        <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][0])) {
                  echo  $filtros['filtros']['estrelas'][0];
                } else {echo '0';} 
            ?>)</span>
    </div>
    <div class="filteritem">
        <input type="checkbox" <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('1', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?> name="filtro[star][]" value="1" id="filtro_star1"
               <?php 
                    if(empty($filtros['filtros']['estrelas'][1])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
        ...
        <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][1])) {
                  echo  $filtros['filtros']['estrelas'][1];
                } else {echo '0';} 
            ?>)</span>
    </div>
    <div class="filteritem">
        <input type="checkbox" 
               <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('2', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?>
               name="filtro[star][]" value="2" id="filtro_star2" 
               <?php 
                    if(empty($filtros['filtros']['estrelas'][2])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
       ...
       <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][2])) {
                  echo  $filtros['filtros']['estrelas'][2];
                } else {echo '0';} 
            ?>)</span>
    </div>
    <div class="filteritem">
        <input type="checkbox" 
               <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('3', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?>
               name="filtro[star][]" value="3" id="filtro_star3" 
               <?php 
                    if(empty($filtros['filtros']['estrelas'][3])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
        ...
        <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][3])) {
                  echo  $filtros['filtros']['estrelas'][3];
                } else {echo '0';} 
            ?>)</span>
    </div>
    <div class="filteritem">
        <input type="checkbox" 
               <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('4', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?>
               name="filtro[star][]" value="4" id="filtro_star4"
               <?php 
                    if(empty($filtros['filtros']['estrelas'][4])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
        ...
        <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][4])) {
                  echo  $filtros['filtros']['estrelas'][4];
                } else {echo '0';} 
            ?>)</span>
    </div>
    <div class="filteritem">
        <input type="checkbox" 
               <?php 
                    echo (isset($filtros_selecionados['filtros']['star']) && in_array('5', $filtros_selecionados['filtros']['star']))?'checked="checked"':'';
                    ?>
               name="filtro[star][]" value="5" id="filtro_star5" 
               <?php 
                    if(empty($filtros['filtros']['estrelas'][5])) {
                        echo 'disabled=""';
                    }
                ?>
               /> 
        ...
        <span style="float:right">(<?php  
                if(!empty($filtros['filtros']['estrelas'][5])) {
                  echo  $filtros['filtros']['estrelas'][5];
                } else {echo '0';} 
            ?>)</span>
    </div>
</div>
...
<div class="filterbox">
    ...
    <div class="filtercontent">
        <div class="filteritem">
            <input type="checkbox" 
                   <?php 
                    echo (isset($filtros_selecionados['filtros']['promocao']) && $filtros_selecionados['filtros']['promocao'] == 1)?'checked="checked"':'';
                    ?> 
                   value= "1" name="filtro[promocao]" id="filtro_promocao" 
                   <?php 
            if(empty($filtros['filtros']['promocao']['qtde'])) { echo 'disabled=""';}
        ?> 
                   /> 
            <label for="filtro_promocao"><?php $this->lang->get('SALE'); ?> </label>
            <span style='float:right'>(<?php echo (!empty($filtros['filtros']['promocao']['qtde']))? $filtros['filtros']['promocao']['qtde']:'0'; ?>)</span>
        </div>
    </div>
</div>
...
<div class="filterbox">
    ...
    if(!empty($filtros['filtros']['opcoes'])):
        foreach($filtros['filtros']['opcoes'] as $opcoes):
        ...
        <?php foreach($opcoes['opcao'] as $op):?>
            <div class="filteritem">     
                <input type="checkbox" 
                       <?php 
                    echo (isset($filtros_selecionados['filtros']['opcoes']) && in_array($op['valor'], $filtros_selecionados['filtros']['opcoes']))?'checked="checked"':'';
