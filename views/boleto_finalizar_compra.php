...
<h1 style="text-align: center"><b>Finalizar Compra - Boleto</b></h1><br/>
    ...
    <div class="col-md-11 user">
        ...
        <div class="col-md-12 endereco" style="padding-bottom: 10px;padding-top: 10px">
            <div class="col-md-5">
                ...
                <div class="col-md-10">
                    <a href="<?php echo BASE_URL?>perfil/meus_dados?tipo=boleto"><span id="sair">Editar Dados</span></a>
                </div>
            </div>
        ...
        <?php if(!isset($dados['endereco'])): ?>
            ...
            <a href="<?php echo BASE_URL?>perfil/enderecos?tipo=boleto"><span id="sair">Cadastrar Endereço</span></a>
        <?php else: ?>
            ...
            <div class="col-md-5">
                ...
                <div class="col-md-10">
                    <a href="<?php echo BASE_URL?>perfil/enderecos?tipo=boleto"><span id="sair">Editar Endereço de Entrega</span></a>
                </div>
            </div>
